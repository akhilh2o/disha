                        ...
                        <div class="navbar-collapse collapse" id="navbarsExample03">
                            <ul class="nav navbar-nav">
                                <li @class(['nav-item', 'active'=> request()->segment('2')=='exams'])>
                                    <a href="{{ route('quiz.exams') }}" class="nav-link">Exams</a>
                                </li>
                                <li @class(['nav-item', 'active'=> request()->segment('2')=='certificates'])>
                                    <a href="{{ route('quiz.certificates') }}" class="nav-link">Previous Exam</a>
                                </li>
                                <li @class(['nav-item', 'active'=> request()->segment('2')=='profile'])>
                                    <a href="{{ route('quiz.profile') }}" class="nav-link">Profile</a>
                                </li>
                                <li class="nav-item">
